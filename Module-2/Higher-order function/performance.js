...
const employees = [
    { name: "Bhavya", tasksCompleted: 8, rating: 4.7 },
    { name: "Chandu", tasksCompleted: 4, rating: 4.0 },
    { name: "Reethu", tasksCompleted: 6, rating: 3.5 },
    { name: "Rishi", tasksCompleted: 10, rating: 4.9 },
    { name: "Bhavani", tasksCompleted: 7, rating: 2.8 }
];
